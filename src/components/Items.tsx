...
export default function Items() {
  ...
  return (
    <div className="xl:w-4/12 border h-6/6 flex flex-col">
      <p className="p-2 font-bold w-full text-center  text-slate-800">ADD TODO</p>
      <section className="flex flex-col gap-1.5 p-7 w-full justify-between h-full">
